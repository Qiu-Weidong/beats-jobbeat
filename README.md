...
`${GOPATH}/src/github.com/Qiu-Weidong/jobbeat`
...
```
git remote set-url origin https://github.com/Qiu-Weidong/jobbeat
...
in the same directory with the name jobbeat.
...
```
mkdir -p ${GOPATH}/src/github.com/Qiu-Weidong/jobbeat
git clone https://github.com/Qiu-Weidong/jobbeat ${GOPATH}/src/github.com/Qiu-Weidong/jobbeat
```
